    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{{route('task.edit',$item->id)}}"><button class="btn btn-success">Modifier</button></a>
                <button  value="{{$id}}" name="brief_id" class="btn btn-danger">Supprimer</button>
...
<form action="{{route('task.create')}}" method="get">
    ...
    <button class="btn btn-primary">Ajouté une tâche</button>
</form>
